...
import wrenchAndScrewdriverIcon from '~assets/sf-symbols/wrench.and.screwdriver.fill.svg'

export const finderMenuBarItems: ApplicationMenuBarItem[] = [
  {
    id: 'app',
    label: '访达',
    items: [
      { id: 'about-finder', label: '关于访达' },
      ...
      { id: 'hide-finder', label: '隐藏访达', shortcut: '⌘H' },
  ...
  },
  {
    ...
    label: '文件',
    items: [
      { id: 'new-finder-window', label: '新建“访达”窗口', shortcut: '⌘N' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'divider-1', type: 'separator' },
      { id: 'recents', label: '最近使用', shortcut: '⇧⌘F', icon: clockIcon },
      { id: 'documents', label: '文稿', shortcut: '⇧⌘O', icon: documentIcon, iconScale: 1.25 },
      { id: 'desktop', label: '桌面', shortcut: '⇧⌘D', icon: menubarDockIcon, iconScale: 1.3 },
      { id: 'downloads', label: '下载', shortcut: '⌥⌘L', icon: arrowDownCircleIcon },
      { id: 'home', label: '个人', shortcut: '⇧⌘H', icon: houseIcon },
      { id: 'computer', label: '电脑', shortcut: '⇧⌘C', icon: laptopIcon, iconScale: 1.5 },
      { id: 'airdrop', label: '隔空投送', shortcut: '⇧⌘R', icon: menubarDockIcon, iconScale: 1.3 },
      { id: 'network', label: '网络', shortcut: '⇧⌘K', icon: networkIcon },
      { id: 'icloud', label: 'iCloud 云盘', shortcut: '⇧⌘I', icon: icloudIcon, iconScale: 1.34 },
      { id: 'shared', label: '共享', shortcut: '⇧⌘S', icon: folderBadgePersonIcon, iconScale: 1.73 },
      { id: 'applications', label: '应用程序', shortcut: '⇧⌘A', icon: menubarDockIcon, iconScale: 1.3 },
      { id: 'utilities', label: '实用工具', shortcut: '⇧⌘U', icon: wrenchAndScrewdriverIcon },
      { id: 'divider-2', type: 'separator' },
...
export default finderMenuBarItems

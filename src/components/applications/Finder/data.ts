import type { FinderListItem, FinderSidebarSection, FinderTab } from './types'

export const sidebarSections: FinderSidebarSection[] = [
  {
    id: 'favorites',
    title: '个人收藏',
    items: [
      { id: 'recents', label: '最近使用', icon: 'recents' },
...
export const finderTabs: FinderTab[] = [
  { id: 'components', label: 'components', active: true },
  { id: 'downloads', label: '下载' },
  { id: 'claude', label: '.claude' },
]

export const finderItems: FinderListItem[] = [
  {
    id: 'applications',
    name: 'applications',
    modified: '今天 14:50',

...
function Select(props: SelectProps) {
  ...
  return (
    <div className="relative w-full">
      <button
        className="relative w-full h-[1.72rem] box-border rounded-[.42rem] border border-#d2d2d2 bg-white pl-[.55rem] pr-[2rem] flex items-center gap-[.42rem] cursor-default"
        onClick={openMenu}
        ref={triggerRef}
        type="button"
      >
